...
var LG_fr = {
    ...
    articles: [
      ...
      },
      {
        ...
        list: [
          ...
          "Module Admin",
          '<a href="https://tournois.belotenotdead.com" target="_blank">Tournois.belotenotdead.com</a>',
      ...
      { titre: "JPower", image: "jpower", width: "6u", desc: "Interface de provisionning de serveur DNS 'PowerDns'" },
      {
        titre: "Outils de gestion Classe 4",
        image: "class4",
        width: "6u",
  ...
  contact: {
    intro:
      "N'hésitez pas à me contacter pour un devis gratuit, je vous répondrai rapidement, à votre convenance par mail ou par téléphone.",
    nom: "Nom",
    email: "Email",
    societe: "Société",
...
var LG_en = {
  ...
  demo: {
    ...
    articles: [
      ...
      {
        titre: "ORO: Time management",
        image: "oro",
        width: "12u",
        desc: "Time management application for teams working on sereval projects",
        list: ["Multi users", "Activity reports", "Project configuration", "PHP, MySql, JqueryUI"],
      },
      { titre: "JPower", image: "jpower", width: "6u", desc: "Commissioning web interface for DNS server 'PowerDns'" },
      {
        titre: "Class 4 management tools",
        image: "class4",
        width: "6u",
  ...
  contact: {
    intro:
      "Please don't hesitate to contact me for a free quotation, I will reply quickly, either by email or by phone as requested.",
    nom: "Name",
    email: "Email",
    societe: "Company",
